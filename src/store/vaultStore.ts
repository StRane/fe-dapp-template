...
export interface VaultData {
    ...
    totalBorrowed: any; // BN from anchor (u64)
    borrowIndex: any;   // BN from anchor (u64)
    borrowRate: any;    // BN from anchor (u64)
    lastUpdateTime: any; // BN from anchor (i64)
    reserveFactor: any;  // BN from anchor (u64)
    totalReserves: any;  // BN from anchor (u64)
    totalShares: any;    // BN from anchor (u64)
    bump: number;        // u8
}
